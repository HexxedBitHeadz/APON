Run Normal: (RECOMMENDED)
```powershell
.\spray.ps1 -File .\passwords.txt -Admin
```
Run Verbose: (NOT RECOMMENDED)
```powershell
.\spray.ps1 -File .\passwords.txt -Verbose -Admin
```
```powershell
.\spray.ps1 -Pass 1q2w3e4r5t -Verbose -Admin
```
```powershell
<#
  .SYNOPSIS
